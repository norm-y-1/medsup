...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-CFrggY43.js', import.meta.url).href),import:true,requiredVersion:'^19.1.1'},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-K6yWWQEs.js', import.meta.url).href),import:true,requiredVersion:'^19.1.1'}};
